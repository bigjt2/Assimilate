...
note_table:
    ...
    .word $06AD, $064D, $05F3, $059D, $054D, $0500, $04B8, $0475, $0435                      ; C1-Ab1 ($5E-$66) Not originally part of metalslime's table
    .word $0000  ;rest

;notes in the range (C1-Ab1) I added to the note table won't
;fit correctly with the note offset because of where they are.
;therefore, you can't use set_note_offset for them.
;you have to manually enter recalculate them.
