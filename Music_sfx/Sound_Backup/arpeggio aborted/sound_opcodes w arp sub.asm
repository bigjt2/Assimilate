...
;    .word se_op_set_arpeggio        ;$A9
    .word se_op_change_tempo        ;$A9
    .word se_op_stream_wait         ;$AA
...
se_op_stream_wait:
  ...
  LDA [sound_ptr], y  ;pointer looking at which stream to set
  TAX
  INY                 ;inc pointer to 0/1
  LDA [sound_ptr], y
...
;se_op_set_arpeggio:
;  TYA
;  PHA    ;push current y to stack

;  LDA [sound_ptr], y      ;read the argument
;  ASL A
;  TAY

;  LDA arpeggio_index, y   ;store in curr_arp to create the pointer
;  STA curr_arp
;  LDA arpeggio_index+1, y
;  STA curr_arp+1

;  LDA #$00                ;reset arp_index
;  STA arp_index

;  PLA
;  TAY                     ;restore current y
