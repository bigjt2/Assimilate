...
;----- first 8k bank of PRG-ROM
    ...
    .include "sound_engine_test.asm"
    .include "note_table.i" ;period lookup table for notes
    .include "note_length_table.i"
    .include "vol_envelopes.i"

    .include "Songs_Sfx\song_silence.i"
    .include "Songs_Sfx\song_test.i"
    .include "Songs_Sfx\song_awesome.i"
    .include "Songs_Sfx\song_boss.i"
    .include "Songs_Sfx\song_moon.i"
    .include "Songs_Sfx\song_soviet.i"
    .include "Songs_Sfx\song_asia.i"
    .include "Songs_Sfx\song_cows.i"
    .include "Songs_Sfx\song_final_boss.i"
    .include "Songs_Sfx\song_title.i"
    .include "Songs_Sfx\song_cutscene.i"
    .include "Songs_Sfx\song_final_victory.i"
    .include "Songs_Sfx\song_cricket.i"
    .include "Songs_Sfx\song_asia_night.i"
    .include "Songs_Sfx\song_cs_begin.i"
    .include "Songs_Sfx\song_cs_boss.i"

    .include "Songs_Sfx\sfx_endstg_fnfr.i"
    .include "Songs_Sfx\song_endstg_fnfr.i"
    .include "Songs_Sfx\sfx_EMP.i"
    .include "Songs_Sfx\sfx_beam.i"
    .include "Songs_Sfx\sfx_Ossan_die.i"
    .include "Songs_Sfx\sfx_assimilate.i"
    .include "Songs_Sfx\sfx_explosion.i"
    .include "Songs_Sfx\sfx_1up.i"
    .include "Songs_Sfx\sfx_klaser.i"
...
;----------------------
; sodng_up will move selection up a song.  Last song will wrap to song 1   
song_up:
    inc current_song
    lda current_song
