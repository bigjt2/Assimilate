...
sound_opcodes:
    ...
    .word se_op_transpose           ;$AA
    .word se_op_change_tempo        ;$AB
    .word se_op_stream_wait         ;$AC
    .word se_op_continue_fanfare    ;$AD
...
se_op_set_loop2_counter:
    lda [sound_ptr], y      ;read the argument (# times to loop)
    sta stream_loop2, x     ;store it in the loop counter variable
    rts

se_op_loop2:
    dec stream_loop2, x     ;decrement the counter
    lda stream_loop2, x
    beq .last_iteration     ;if zero, we are done looping
    jmp se_op_infinite_loop ;if not zero, jump back
.last_iteration:
