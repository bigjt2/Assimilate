...
stream_loop2 .rs 6          ;2nd loop counter, for use with outer loops
...
bank_backup_se:
  LDA prg_bank
  STA bank_bak_se         ;back up current level/boss data PRG swap bank
  LDA #$00                ;switch to swap bank where song data is held
  STA prg_bank
  JSR swap_PRG_bank
...
NUM_SONGS = $19 ;if you add a new song, change this number.    
...
song_headers:
    ...
    .word song_awesome
    .word song_boss
    .word sfx_endstg_fanfare
    .word song_endstg_fanfare
    .word sfx_EMP
    .word sfx_beam
    .word sfx_Ossan_die
    .word song_moon
    ...
    .word song_asia
    .word song_cows
    .word song_final_boss
    .word song_cutscene
    .word song_final_victory
    .word song_cricket
    .word song_asia_night
    .word song_cs_begin
    .word song_cs_boss
    .word sfx_assimilate
    .word sfx_explosion
